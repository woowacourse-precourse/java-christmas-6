...
public enum DiscountFactory {
    D_DAY("크리스마스 디데이 할인") {
        ...
        int getDiscountPrice(PromotionDate promotionDate, Orders orders) {
            return D_DAY_START_PRICE + promotionDate.calcAfterDate(PromotionDate.FIRST_DAY) * D_DAY_INCRESEMENT_PRICE;
        }
        ...
        @Override
        int getDiscountPrice(PromotionDate promotionDate, Orders orders) {
            return orders.calcMenuCountOf(Category.DESSERT) * WEEK_DISCOUNT;
        }
    },
    WEEKEND_DISCOUNT("주말 할인") {
        ...
        @Override
        int getDiscountPrice(PromotionDate promotionDate, Orders orders) {
            return orders.calcMenuCountOf(Category.MAIN_COURSE) * WEEK_DISCOUNT;
        }
    },
