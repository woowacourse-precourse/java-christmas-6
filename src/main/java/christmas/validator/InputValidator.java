...
public class InputValidator {
    ...
    public SimpleEntry<Menu, Integer> validateOrderStateFormat(List<Menu> menu, String menuOrdered)
    ...
    public void checkDuplicatedMenus(List<SimpleEntry<Menu, Integer>> orderedList)
        throws IllegalArgumentException {
    ...
    public void checkCategory(List<SimpleEntry<Menu, Integer>> orderedList)
        throws IllegalArgumentException {
        boolean isAnyMatchedExceptDrink = orderedList.stream()
            .anyMatch(el -> !el.getKey().checkCategory(DRINK));
